...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.41; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.63125; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1; // Multiplier in the X direction (forwards)

    public static double Y_MULTIPLIER = 1.014; // Multiplier in the Y direction (leftwards)
